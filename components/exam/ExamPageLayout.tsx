      ...
      const handleScroll = () => {
         if (!ticking) {
            window.requestAnimationFrame(() => {
               ...
               if (!hasShownPopup && scrollPos > 1000) { // simplified condition to avoid layout thrashing
                  setShowPopup(true);
   ...
   return (
      <div className="bg-white text-[#1e293b] min-h-screen font-body text-xs md:text-base selection:bg-[#1565d8] selection:text-white">
         ...
         <div className="fixed bottom-10 right-6 z-[100000] md:bottom-12 md:right-10">
            <a className="w-14 h-14 md:w-16 md:h-16 bg-[#25D366] rounded-full flex items-center justify-center border-4 border-white shadow-2xl hover:scale-110 transition-transform animate-bounce" href="https://wa.me/919325216364" target="_blank" rel="noopener noreferrer">
