   ...
   return (
      <section className="py-16 md:py-24 px-4 md:px-6 lg:px-16 bg-gradient-to-br from-slate-50 to-emerald-50/30 relative z-10 border-b border-outline-variant">
         <div className="max-w-[1200px] mx-auto space-y-10 md:space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-5 md:gap-6 auto-rows-[240px] md:auto-rows-[300px]">

               {/* Box 1 - Big Highlight */}
               <div className="md:col-span-8 bg-white/80 backdrop-blur-sm rounded-[1.5rem] md:rounded-[2rem] p-8 md:p-10 relative overflow-hidden border border-outline transition-all duration-300 hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-1 hover:border-emerald-500/30 group flex flex-col justify-between">
               ...
               <div className="md:col-span-4 bg-gradient-to-br from-slate-900 to-slate-800 rounded-[1.5rem] md:rounded-[2rem] p-8 relative overflow-hidden flex flex-col justify-between text-white shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 group">
               ...
               <div className="md:col-span-4 bg-surface-dim rounded-[1.5rem] md:rounded-[2rem] p-8 relative overflow-hidden flex flex-col justify-between border border-outline-variant hover:shadow-xl hover:shadow-teal-900/10 hover:-translate-y-1 transition-all duration-300 group">
               ...
               <div className="md:col-span-8 bg-white/80 backdrop-blur-sm rounded-[1.5rem] md:rounded-[2rem] p-6 md:p-8 relative overflow-hidden border border-outline shadow-sm flex flex-col md:flex-row gap-6 md:gap-10 items-center hover:shadow-2xl hover:shadow-primary/10 hover:-translate-y-1 hover:border-emerald-500/30 transition-all duration-300 group">
                  ...
                  <div className="w-full md:w-[45%] h-40 md:h-full rounded-[1rem] md:rounded-[1.5rem] overflow-hidden relative shadow-inner group-hover:shadow-lg transition-shadow duration-300">
