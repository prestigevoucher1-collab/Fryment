...
import Navbar from "@/components/pte/Navbar";
import HeroSection from "@/components/pte/HeroSection";
import TrustBar from "@/components/pte/TrustBar";
import AdvantageSection from "@/components/pte/AdvantageSection";
...
import BlogSection from "@/components/pte/BlogSection";
...
export default function PTEPage() {
   ...
   return (
      <div className="bg-white text-[#1e293b] min-h-screen font-body text-xs md:text-base selection:bg-[#1565d8] selection:text-white">
         ...
         {/* Page content — hidden when mobile menu is open */}
