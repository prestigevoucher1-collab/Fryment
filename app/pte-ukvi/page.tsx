...
const FAQS = [
  { q: "Is PTE UKVI different from PTE Academic?", a: "The test format is exactly the same. The only difference is the registration process and the fact that it is a Secure English Language Test (SELT) approved by the UK Home Office." },
  { q: "Can I use PTE UKVI for studying in the UK?", a: "Yes, it is accepted by almost all UK universities and covers both university admission and visa requirements." },
  { q: "What is the validity of the PTE UKVI voucher?", a: "Your Fryment voucher is valid for 11 months from the date of purchase." },
...
const TESTIMONIALS = [
  { name: "Rohit Verma", city: "Kolkata", score: "65/90", text: "I needed a SELT test for my UK work visa. PTE UKVI was perfect and Fryment gave a great discount.", rating: 5 },
  { name: "Sneha Reddy", city: "Hyderabad", score: "72/90", text: "Got the code instantly on WhatsApp. Booked my slot for the next day. Fast and reliable service.", rating: 5 }
];
...
const UNIVERSITIES = [
  ...
  "University of Edinburgh", "King's College London", "LSE", "University of Manchester"
];

function cn(...classes: any[]) { return classes.filter(Boolean).join(" "); }

export default function UKVIPage() {
  const [isBookingModalOpen, setIsBookingModalOpen] = useState(false);
  const [formData, setFormData] = useState({ fullName: "", phone: "", email: "", state: "", quantity: "1", examType: "PTE UKVI" });
  ...
  const currentPricing = (PRICING_DATA as any)[formData.examType] || PRICING_DATA["PTE UKVI"];
  ...
  return (
    <div className="bg-white min-h-screen text-[#0f172a] font-sans selection:bg-amber-200 overflow-x-hidden">
        ...
        {isBookingModalOpen && (
          ...
          >
            ...
            >
              ...
              {/* Modal Header — PTE UKVI brand green */}
              <div className="bg-[#0f766e] p-8 text-center relative overflow-hidden">
                ...
                <h3 className="text-2xl font-black text-white">Book PTE UKVI</h3>
                        ...
                        <motion.div key="s2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-5">
                          <div className="bg-slate-50 rounded-2xl p-5 border border-slate-100 space-y-3">
                            <div className="flex justify-between text-sm font-medium text-slate-500">
                              <span>Official PTE UKVI Price</span>
      ...
      <main>
        ...
        <section className="relative pt-32 pb-0 px-6 overflow-hidden bg-gradient-to-b from-[#f0f9ff] to-white">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-400 font-medium mb-8">
              ...
              <ChevronRight className="w-4 h-4" />
              <span className="text-[#0f172a] font-bold">PTE UKVI</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-12 items-center pb-16">
              ...
              <div className="space-y-7">
                ...
                <p className="text-lg text-slate-500 leading-relaxed max-w-xl">
                  India's most trusted source for discounted PTE UKVI vouchers. Pay in INR via UPI or Card — zero forex charges, instant WhatsApp delivery.
                </p>

                {/* Quick Stats */}
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  {[
                    { icon: Clock, label: "2 Hours", sub: "Test Duration" },
                    { icon: Zap, label: "48 Hours", sub: "Results" },
                    { icon: Globe, label: "UK Visa", sub: "Acceptance" },
                    { icon: Award, label: "Secure", sub: "Environment" }
              ...
              <div className="bg-white rounded-[28px] p-8 border border-slate-200 shadow-2xl shadow-slate-200/60 relative overflow-hidden">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-xl font-black text-[#0f172a]">PTE UKVI</p>
                  </div>
        ...
        <section id="details" className="py-24 px-6 bg-white">
          <div className="max-w-6xl mx-auto space-y-16">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-[#0f172a]">What is the PTE UKVI?</h2>
              <p className="text-slate-500 mt-4 leading-relaxed">The PTE UKVI is a modern, AI-powered English proficiency test designed for today's global student. It's fast, affordable, and accepted by thousands of universities worldwide.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
              <div className="space-y-6">
                ...
                {[
                  ...
                  { icon: ShieldCheck, title: "UK Home Office Approved", desc: "Fully approved for all UK visas that require a Secure English Language Test (SELT).", color: "text-violet-600 bg-violet-50" },
                  { icon: Zap, title: "Results in 48 Hours", desc: "Fastest SELT test results. AI scoring guarantees unbiased grading.", color: "text-amber-600 bg-amber-50" },
                  { icon: Globe, title: "For UK Visas", desc: "Ideal for student visas, work visas, and settlement in the UK.", color: "text-emerald-600 bg-emerald-50" },
                  { icon: TrendingUp, title: "Score: 10–90", desc: "Check your specific visa category for the exact score requirement.", color: "text-rose-600 bg-rose-50" },
                  { icon: Award, title: "SELT Certified", desc: "Pearson PTE UKVI is a Secure English Language Test (SELT) that is accepted by the UK Home Office.", color: "text-indigo-600 bg-indigo-50" }
        ...
        <section id="score" className="py-24 px-6 bg-[#f8fafc]">
          <div className="max-w-5xl mx-auto space-y-14">
            <div className="text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-[#0f172a]">How PTE UKVI Scores Work</h2>
              <p className="text-slate-500 mt-3 max-w-lg mx-auto">Your PTE UKVI result includes an overall score and four subscores that measure different language skills.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
              ...
              <div className="space-y-4">
                ...
                {[
                  ...
                  { tier: "Top 50 Global Universities", range: "43+", color: "text-violet-700 bg-violet-50 border-violet-100" },
                  { tier: "Student Visa (Degree)", range: "59+", color: "text-blue-700 bg-blue-50 border-blue-100" },
                  { tier: "Student Visa (Below Degree)", range: "43+", color: "text-teal-700 bg-teal-50 border-teal-100" },
                  { tier: "Settlement/Citizenship", range: "Varies", color: "text-slate-600 bg-slate-50 border-slate-100" }
                ...
                <div className="bg-amber-50 border border-amber-100 rounded-xl p-4 mt-4">
                  <p className="text-sm text-amber-800 font-medium flex items-start gap-2">
                    ...
                    Requirements vary by program and country. Always check the official university admissions page for the exact PTE UKVI score cutoff.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-24 px-6 bg-[#f8fafc]">
          <div className="max-w-5xl mx-auto space-y-14">
            <div className="text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-[#0f172a]">How to Book Your PTE UKVI Voucher</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
              ...
              {[
                ...
                { step: "03", icon: ExternalLink, title: "Go to PTE UKVI.com", desc: "Visit the official PTE UKVI website and redeem your code." },
        ...
        {/* COMPARISON — PTE UKVI vs Alternatives */}
        <section className="py-24 px-6 bg-white">
          <div className="max-w-5xl mx-auto space-y-12">
            <div className="text-center">
              <p className="text-xs font-bold text-[#0f766e] uppercase tracking-widest mb-3">Comparison</p>
              <h2 className="text-3xl md:text-4xl font-black text-[#0f172a]">PTE UKVI vs. IELTS vs. TOEFL</h2>
              <p className="text-slate-500 mt-3 max-w-lg mx-auto">See why thousands of Indian students are choosing the PTE UKVI.</p>
            </div>
            ...
            <div className="rounded-3xl overflow-hidden border border-slate-200 shadow-lg">
              <div className="grid grid-cols-4 bg-slate-50 border-b border-slate-200">
                ...
                <div className="p-5 text-center text-sm font-black text-[#0f766e] uppercase tracking-wider border-x border-slate-200 bg-[#f0fdfa]">PTE UKVI</div>
            ...
            <div className="text-center">
              <button onClick={() => setIsBookingModalOpen(true)} className="bg-[#0f766e] text-white font-black rounded-xl px-8 py-4 hover:bg-[#0d9488] transition-colors shadow-lg shadow-teal-400/20">
                Get PTE UKVI Voucher at ₹14,200 →
              </button>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-[#0f172a] text-white relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
            <div className="inline-flex items-center gap-2 bg-white/10 text-white px-4 py-2 rounded-full text-sm font-bold border border-white/10">
              <Flame className="w-4 h-4 text-[#0f766e]" /> Limited time — Save ₹2,800 on your PTE UKVI
            </div>
            <h2 className="text-4xl md:text-5xl font-black leading-tight">
              Ready to Take the<br />
              <span className="text-[#0f766e]">PTE UKVI?</span>
            </h2>
