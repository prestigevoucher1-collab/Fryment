...
const FAQS = [
  { q: "Is PTE Core approved for Canada PR?", a: "Yes, PTE Core is officially approved by the IRCC for all Canadian economic visa categories." },
  { q: "How is PTE Core different from PTE Academic?", a: "PTE Core tests general, everyday English instead of academic English. Tasks include writing emails and responding to real-life situations." },
  { q: "What is the validity of the PTE Core voucher?", a: "Your Fryment voucher is valid for 11 months from the date of purchase." },
...
const TESTIMONIALS = [
  { name: "Vikram Singh", city: "Chandigarh", score: "85/90", text: "Got my target CLB 9 easily with PTE Core. Fryment voucher saved me ₹2800 on the booking fee.", rating: 5 },
  { name: "Simran Kaur", city: "Amritsar", score: "75/90", text: "Very smooth booking experience. Fast delivery on WhatsApp and cheaper than paying directly.", rating: 5 }
];

const SCORE_BREAKDOWN = [
  { skill: "Speaking", desc: "Oral fluency and pronunciation in daily life", color: "bg-blue-500", width: "w-[85%]" },
  { skill: "Writing", desc: "Grammar, spelling, and vocational vocabulary", color: "bg-teal-500", width: "w-[80%]" },
  { skill: "Reading", desc: "Comprehension of general texts", color: "bg-violet-500", width: "w-[75%]" },
  { skill: "Listening", desc: "Understanding spoken everyday English", color: "bg-amber-500", width: "w-[78%]" }
];

const UNIVERSITIES = [
  "Express Entry", "Provincial Nominee Program (PNP)", "Canadian Citizenship", "Federal Skilled Worker",
  "Canadian Experience Class", "Federal Skilled Trades", "Start-up Visa", "Self-employed Persons"
];
...
export default function CorePage() {
  ...
  const [formData, setFormData] = useState({ fullName: "", phone: "", email: "", state: "", quantity: "1", examType: "PTE Core" });
  ...
  const currentPricing = (PRICING_DATA as any)[formData.examType] || PRICING_DATA["PTE Core"];
  ...
  return (
    <div className="bg-white min-h-screen text-[#0f172a] font-sans selection:bg-amber-200 overflow-x-hidden">
        ...
        {isBookingModalOpen && (
          ...
          >
            ...
            >
              ...
              {/* Modal Header — PTE Core brand green */}
              <div className="bg-[#0f766e] p-8 text-center relative overflow-hidden">
                ...
                <h3 className="text-2xl font-black text-white">Book PTE Core</h3>
                        ...
                        <motion.div key="s2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-5">
                          <div className="bg-slate-50 rounded-2xl p-5 border border-slate-100 space-y-3">
                            <div className="flex justify-between text-sm font-medium text-slate-500">
                              <span>Official PTE Core Price</span>
      ...
      <main>
        ...
        <section className="relative pt-32 pb-0 px-6 overflow-hidden bg-gradient-to-b from-[#f0f9ff] to-white">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-400 font-medium mb-8">
              ...
              <ChevronRight className="w-4 h-4" />
              <span className="text-[#0f172a] font-bold">PTE Core</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-12 items-center pb-16">
              ...
              <div className="space-y-7">
                ...
                <p className="text-lg text-slate-500 leading-relaxed max-w-xl">
                  India's most trusted source for discounted PTE Core vouchers. Pay in INR via UPI or Card — zero forex charges, instant WhatsApp delivery.
                </p>

                {/* Quick Stats */}
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  {[
                    { icon: Clock, label: "2 Hours", sub: "Test Duration" }, { icon: Zap, label: "48 Hours", sub: "Results" },
                    { icon: Globe, label: "Canada PR", sub: "Acceptance" },
                    { icon: Award, label: "Everyday", sub: "English" }
              ...
              <div className="bg-white rounded-[28px] p-8 border border-slate-200 shadow-2xl shadow-slate-200/60 relative overflow-hidden">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-xl font-black text-[#0f172a]">PTE Core</p>
                  </div>
        ...
        <section id="details" className="py-24 px-6 bg-white">
          <div className="max-w-6xl mx-auto space-y-16">
            <div className="text-center max-w-2xl mx-auto">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-[#0f172a]">What is the PTE Core?</h2>
              <p className="text-slate-500 mt-4 leading-relaxed">The PTE Core is a modern, AI-powered English proficiency test designed for today's global student. It's fast, affordable, and accepted by thousands of universities worldwide.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
              <div className="space-y-6">
                ...
                {[
                  ...
                  { icon: Clock, title: "2 Hours Total", desc: "The test evaluates your speaking, writing, reading, and listening skills in one single 2-hour session.", color: "text-[#0f766e] bg-[#ccfbf1]" },
                  { icon: ShieldCheck, title: "IRCC Approved", desc: "Fully approved by the IRCC for Canadian permanent residency and citizenship applications.", color: "text-violet-600 bg-violet-50" },
                  { icon: Zap, title: "Results in 48 Hours", desc: "Fastest test results for Canadian PR. AI scoring guarantees unbiased grading.", color: "text-amber-600 bg-amber-50" },
                  { icon: MessageCircle, title: "Everyday English", desc: "Focuses on general, vocational, and real-life English scenarios rather than academic English.", color: "text-emerald-600 bg-emerald-50" },
                  { icon: TrendingUp, title: "Score: 10–90", desc: "Check the CLB (Canadian Language Benchmark) equivalent for your specific score.", color: "text-rose-600 bg-rose-50" },
                  { icon: Award, title: "IRCC Validated", desc: "PTE Core is the newest general English test approved by the IRCC for Canadian migration.", color: "text-indigo-600 bg-indigo-50" }
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { part: "Part 1", title: "Speaking & Writing (50 min)", desc: "Read aloud, respond to situations, and write emails.", badge: "Scored" },
                    { part: "Part 2", title: "Reading (30 min)", desc: "Multiple choice, reorder paragraphs, and fill in the blanks.", badge: "Scored" },
                    { part: "Part 3", title: "Listening (30 min)", desc: "Summarize spoken text, highlight incorrect words, and select missing words.", badge: "Scored" }
        ...
        <section id="score" className="py-24 px-6 bg-[#f8fafc]">
          <div className="max-w-5xl mx-auto space-y-14">
            <div className="text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-[#0f172a]">How PTE Core Scores Work</h2>
              <p className="text-slate-500 mt-3 max-w-lg mx-auto">Your PTE Core result includes an overall score and four subscores that measure different language skills.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
              ...
              <div className="space-y-4">
                ...
                {[
                  ...
                  { tier: "Top 50 Global Universities", range: "82 - 90", color: "text-violet-700 bg-violet-50 border-violet-100" },
                  { tier: "Top 100–200 Universities", range: "71 - 81", color: "text-blue-700 bg-blue-50 border-blue-100" },
                  { tier: "Good Universities (200–500)", range: "60 - 70", color: "text-teal-700 bg-teal-50 border-teal-100" },
                  { tier: "Pathway Programs", range: "43 - 59", color: "text-slate-600 bg-slate-50 border-slate-100" }
                ...
                <div className="bg-amber-50 border border-amber-100 rounded-xl p-4 mt-4">
                  <p className="text-sm text-amber-800 font-medium flex items-start gap-2">
                    ...
                    Requirements vary by program and country. Always check the official university admissions page for the exact PTE Core score cutoff.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-24 px-6 bg-[#f8fafc]">
          <div className="max-w-5xl mx-auto space-y-14">
            <div className="text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-[#0f172a]">How to Book Your PTE Core Voucher</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
              ...
              {[
                ...
                { step: "03", icon: ExternalLink, title: "Go to PTE Core.com", desc: "Visit the official PTE Core website and redeem your code." },
        ...
        {/* COMPARISON — PTE Core vs Alternatives */}
        <section className="py-24 px-6 bg-white">
          <div className="max-w-5xl mx-auto space-y-12">
            <div className="text-center">
              <p className="text-xs font-bold text-[#0f766e] uppercase tracking-widest mb-3">Comparison</p>
              <h2 className="text-3xl md:text-4xl font-black text-[#0f172a]">PTE Core vs. IELTS vs. TOEFL</h2>
              <p className="text-slate-500 mt-3 max-w-lg mx-auto">See why thousands of Indian students are choosing the PTE Core.</p>
            </div>
            ...
            <div className="rounded-3xl overflow-hidden border border-slate-200 shadow-lg">
              <div className="grid grid-cols-4 bg-slate-50 border-b border-slate-200">
                ...
                <div className="p-5 text-center text-sm font-black text-[#0f766e] uppercase tracking-wider border-x border-slate-200 bg-[#f0fdfa]">PTE Core</div>
            ...
            <div className="text-center">
              <button onClick={() => setIsBookingModalOpen(true)} className="bg-[#0f766e] text-white font-black rounded-xl px-8 py-4 hover:bg-[#0d9488] transition-colors shadow-lg shadow-teal-400/20">
                Get PTE Core Voucher at ₹14,200 →
              </button>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-[#0f172a] text-white relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
            <div className="inline-flex items-center gap-2 bg-white/10 text-white px-4 py-2 rounded-full text-sm font-bold border border-white/10">
              <Flame className="w-4 h-4 text-[#0f766e]" /> Limited time — Save ₹2,800 on your PTE Core
            </div>
            <h2 className="text-4xl md:text-5xl font-black leading-tight">
              Ready to Take the<br />
              <span className="text-[#0f766e]">PTE Core?</span>
            </h2>
