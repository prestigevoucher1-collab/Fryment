...
const FAQS = [
  { q: "Is the new shorter GRE accepted by all universities?", a: "Yes, the new shorter GRE is identical in content and scoring scale to the old GRE, just faster. It is accepted universally." },
  { q: "Can I take the GRE at home?", a: "Yes, you can opt for the GRE General Test at Home, which is monitored by a human proctor online." },
  { q: "How much do I save on the GRE with Fryment?", a: "You save exactly ₹2000 off the official test price when you buy a voucher through Fryment." },
...
const TESTIMONIALS = [
  { name: "Siddharth Jain", city: "Bangalore", score: "328/340", text: "Got the voucher code instantly and booked my GRE immediately. Saved ₹2000 compared to paying ETS directly. Thanks Fryment!", rating: 5 },
  { name: "Pooja Verma", city: "Chennai", score: "318/340", text: "Loved the UPI option. Paying ₹22,500 on an international site was failing repeatedly for me. Fryment made it seamless.", rating: 5 }
];

const SCORE_BREAKDOWN = [
  { skill: "Verbal", desc: "Measures reading comprehension and vocabulary", color: "bg-blue-500", width: "w-[85%]" },
  { skill: "Quantitative", desc: "Measures mathematical and problem-solving skills", color: "bg-teal-500", width: "w-[90%]" },
  { skill: "Writing", desc: "Measures critical thinking and analytical writing", color: "bg-violet-500", width: "w-[70%]" }
];
...
export default function GREPage() {
  ...
  const [formData, setFormData] = useState({ fullName: "", phone: "", email: "", state: "", quantity: "1", examType: "GRE General" });
    ...
    <div className="bg-white min-h-screen text-[#0f172a] font-sans selection:bg-amber-200 overflow-x-hidden">
        ...
        {isBookingModalOpen && (
          ...
          >
            ...
            >
              ...
              {/* Modal Header — GRE brand green */}
              <div className="bg-[#4f46e5] p-8 text-center relative overflow-hidden">
                ...
                <div className="inline-flex items-center gap-1.5 bg-white/20 text-white px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest mb-3 border border-white/20">
                  <Sparkles className="w-3 h-3 text-[#fde047]" /> Save ₹2,000 Today
                </div>
                <h3 className="text-2xl font-black text-white">Book GRE General</h3>
              ...
              <div className="p-8">
                {!submitted && (
                  <div className="flex gap-2 mb-8">
                    <div className={cn("h-1.5 rounded-full transition-all duration-500 w-1/2", formStep >= 1 ? "bg-[#4f46e5]" : "bg-slate-100")} />
                    <div className={cn("h-1.5 rounded-full transition-all duration-500 w-1/2", formStep >= 2 ? "bg-[#4f46e5]" : "bg-slate-100")} />
                  </div>
                )}
                ...
                {submitted ? (
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <motion.div key="s2" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-5">
                          <div className="bg-slate-50 rounded-2xl p-5 border border-slate-100 space-y-3">
                            <div className="flex justify-between text-sm font-medium text-slate-500">
                              <span>Official GRE Price</span>
                              <span className="line-through">₹22,500</span>
                            </div>
                            ...
                            <div className="border-t border-slate-200 pt-3 flex justify-between font-black text-lg">
                              ...
                              <span className="text-[#4f46e5]">₹20,500</span>
                            </div>
                          </div>
                    ...
                    <div className="pt-2 space-y-3">
                      ...
                      {formStep === 2 && (
                        <button type="button" onClick={() => setFormStep(1)} className="w-full text-center text-xs font-bold text-slate-400 hover:text-[#4f46e5] transition-colors">
                          ← Edit Details
                        </button>
                      )}
      ...
      <nav className="fixed top-0 left-0 w-full z-[1000] h-20 bg-white/90 backdrop-blur-xl border-b border-slate-200/50">
        <div className="max-w-7xl mx-auto h-full px-6 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <button onClick={() => setIsBookingModalOpen(true)} className="bg-[#4f46e5] text-white font-black rounded-xl px-5 py-2.5 hover:bg-[#4338ca] transition-colors shadow-lg shadow-indigo-500/20">
              Buy Voucher — ₹20,500
            </button>
          </div>
          {/* Mobile CTA */}
          <button onClick={() => setIsBookingModalOpen(true)} className="lg:hidden bg-[#4f46e5] text-white font-black rounded-xl px-4 py-2.5 text-sm hover:bg-[#4338ca] transition-colors">
            Buy Now
          </button>
        </div>
      </nav>
      ...
      <main>
        ...
        <section className="relative pt-32 pb-0 px-6 overflow-hidden bg-gradient-to-b from-[#f0f9ff] to-white">
          {/* Decorative blobs */}
          <div className="absolute top-20 left-0 w-72 h-72 bg-[#4f46e5]/10 rounded-full blur-3xl pointer-events-none" />
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <div className="flex items-center gap-2 text-sm text-slate-400 font-medium mb-8">
              ...
              <ChevronRight className="w-4 h-4" />
              <span className="text-[#0f172a] font-bold">GRE General</span>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_420px] gap-12 items-center pb-16">
              ...
              <div className="space-y-7">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-[3.2rem] font-black text-[#0f172a] leading-[1.1] tracking-tight">
                  Buy GRE General<br />
                  <span className="text-[#4f46e5]">Voucher at ₹20,500</span>
                </h1>

                <p className="text-lg text-slate-500 leading-relaxed max-w-xl">
                  India's most trusted source for discounted GRE vouchers. Pay in INR via UPI or Card — zero forex charges, instant WhatsApp delivery.
                </p>

                {/* Quick Stats */}
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                  {[
                    { icon: Clock, label: "2 Hours", sub: "Test Duration" }, { icon: Zap, label: "8-10 Days", sub: "Results" }, { icon: Laptop, label: "Center/Home", sub: "Test Format" }, { icon: Award, label: "5 Years", sub: "Validity" }
                  ].map(({ icon: Icon, label, sub }) => (
                    <div key={sub} className="bg-white rounded-2xl p-4 border border-slate-200 shadow-sm text-center">
                      <Icon className="w-5 h-5 text-[#4f46e5] mx-auto mb-2" />
                ...
                <div className="flex flex-wrap gap-4 pt-2">
                  <button onClick={() => setIsBookingModalOpen(true)} className="bg-[#0f172a] text-white font-black text-base rounded-xl px-8 py-4 hover:bg-slate-800 transition-colors shadow-xl flex items-center gap-2">
                    Buy Now — ₹20,500 <ArrowRight className="w-5 h-5" />
                  </button>
              ...
              <div className="bg-white rounded-[28px] p-8 border border-slate-200 shadow-2xl shadow-slate-200/60 relative overflow-hidden">
                <div className="absolute top-0 right-0 bg-[#4f46e5] text-white font-black text-xs px-5 py-2 rounded-bl-2xl">Save 14%</div>

                <div className="space-y-6">
                  <div>
                    <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Exam</p>
                    <p className="text-xl font-black text-[#0f172a]">GRE General</p>
                  </div>
                  ...
                  <div className="bg-[#eef2ff] rounded-2xl p-5 space-y-3">
                    ...
                    <div className="border-t border-[#4f46e5]/20 pt-3 flex justify-between font-black text-2xl">
                      <span>You Pay</span>
                      <span className="text-[#4f46e5]">₹20,500</span>
                    </div>
                  </div>
                  ...
                  <button onClick={() => setIsBookingModalOpen(true)} className="w-full bg-[#4f46e5] text-white font-black text-lg rounded-xl py-4 hover:bg-[#4338ca] transition-colors shadow-lg shadow-indigo-400/20 flex items-center justify-center gap-2">
          ...
          <div className="max-w-6xl mx-auto flex flex-wrap justify-center gap-8 md:gap-16">
            {[
              ...
              <div key={text} className="flex items-center gap-2.5 text-white/80 text-sm font-bold">
                <Icon className="w-5 h-5 text-[#4f46e5]" /> {text}
              </div>
            ))}
          </div>
        </section>
        ...
        <section id="details" className="py-24 px-6 bg-white">
          <div className="max-w-6xl mx-auto space-y-16">
            <div className="text-center max-w-2xl mx-auto">
              <p className="text-xs font-bold text-[#4f46e5] uppercase tracking-widest mb-3">About the Exam</p>
              <h2 className="text-3xl md:text-4xl font-black text-[#0f172a]">What is the GRE General?</h2>
              <p className="text-slate-500 mt-4 leading-relaxed">The GRE is a modern, AI-powered English proficiency test designed for today's global student. It's fast, affordable, and accepted by thousands of universities worldwide.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
              <div className="space-y-6">
                ...
                {[
                  ...
                  { icon: Clock, title: "Shorter Format", desc: "The new GRE General Test takes under 2 hours to complete.", color: "text-[#4f46e5] bg-[#e0e7ff]" },
                  { icon: Laptop, title: "Center or Home", desc: "Choose to take the test at a secure Prometric center or from home.", color: "text-violet-600 bg-violet-50" },
                  { icon: Zap, title: "Fast Results", desc: "Receive your official scores in just 8-10 days.", color: "text-amber-600 bg-amber-50" },
              ...
              <div className="space-y-6">
                ...
                <div className="bg-[#eef2ff] rounded-2xl p-6 border border-[#4f46e5]/20 mt-6">
                  <h4 className="font-bold text-[#0f172a] mb-4 flex items-center gap-2">
                    <Info className="w-5 h-5 text-[#4f46e5]" /> System Requirements
                  </h4>
                  <ul className="space-y-2 text-sm text-slate-600">
                    {[
                      ...
                      <li key={req} className="flex items-center gap-2.5">
                        <Laptop className="w-4 h-4 text-[#4f46e5] shrink-0" /> {req}
                      </li>
                    ))}
                  </ul>
                </div>
        ...
        <section id="score" className="py-24 px-6 bg-[#f8fafc]">
          <div className="max-w-5xl mx-auto space-y-14">
            <div className="text-center">
              <p className="text-xs font-bold text-[#4f46e5] uppercase tracking-widest mb-3">Understanding Your Score</p>
              <h2 className="text-3xl md:text-4xl font-black text-[#0f172a]">How GRE Scores Work</h2>
              <p className="text-slate-500 mt-3 max-w-lg mx-auto">Your GRE result includes an overall score and four subscores that measure different language skills.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-start">
              ...
              <div className="space-y-4">
                ...
                {[
                  ...
                  { tier: "Top 50 Global Universities", range: "325 – 340", color: "text-violet-700 bg-violet-50 border-violet-100" },
                ...
                <div className="bg-amber-50 border border-amber-100 rounded-xl p-4 mt-4">
                  <p className="text-sm text-amber-800 font-medium flex items-start gap-2">
                    ...
                    Requirements vary by program and country. Always check the official university admissions page for the exact GRE score cutoff.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-20 px-6 bg-white border-y border-slate-100">
          <div className="max-w-6xl mx-auto space-y-10 text-center">
            <div>
              <p className="text-xs font-bold text-[#4f46e5] uppercase tracking-widest mb-3">Global Reach</p>
        ...
        <section className="py-24 px-6 bg-[#f8fafc]">
          <div className="max-w-5xl mx-auto space-y-14">
            <div className="text-center">
              ...
              <h2 className="text-3xl md:text-4xl font-black text-[#0f172a]">How to Book Your GRE Voucher</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 relative">
              ...
              {[
                ...
                { step: "03", icon: ExternalLink, title: "Go to GRE.com", desc: "Visit the official GRE General website and redeem your code." },
                ...
                <div key={step} className="flex flex-col items-center text-center space-y-4 relative z-10">
                  <div className="w-16 h-16 bg-white rounded-full flex items-center justify-center border border-slate-200 shadow-md text-[#4f46e5]">
        ...
        {/* COMPARISON — GRE vs Alternatives */}
        <section className="py-24 px-6 bg-white">
          <div className="max-w-5xl mx-auto space-y-12">
            <div className="text-center">
              <p className="text-xs font-bold text-[#4f46e5] uppercase tracking-widest mb-3">Comparison</p>
              <h2 className="text-3xl md:text-4xl font-black text-[#0f172a]">GRE vs. IELTS vs. TOEFL</h2>
              <p className="text-slate-500 mt-3 max-w-lg mx-auto">See why thousands of Indian students are choosing the GRE General.</p>
            </div>
            ...
            <div className="rounded-3xl overflow-hidden border border-slate-200 shadow-lg">
              <div className="grid grid-cols-4 bg-slate-50 border-b border-slate-200">
                ...
                <div className="p-5 text-center text-sm font-black text-[#4f46e5] uppercase tracking-wider border-x border-slate-200 bg-[#eef2ff]">GRE</div>
              ...
              {[
                ...
                { feature: "Fryment Price", det: "₹20,500", ielts: "₹22,500", toefl: "₹22,500" },
                { feature: "Test Duration", det: "Under 2 Hours", ielts: "3h 45m", toefl: "4 Hours" },
                { feature: "Result Time", det: "8-10 days", ielts: "10-15 days", toefl: "8-10 days" },
                { feature: "At-Home Test", det: true, ielts: false, toefl: false },
                { feature: "Validity", det: "5 years", ielts: "5 years", toefl: "5 years" },
                ...
                <div key={feature} className={cn("grid grid-cols-4 border-b border-slate-100 last:border-b-0", i % 2 === 0 ? "bg-white" : "bg-slate-50/50")}>
                  ...
                  <div className="p-5 text-center border-x border-slate-200 bg-[#eef2ff]/50">
                    {det === true ? <CheckCircle2 className="w-5 h-5 text-emerald-500 mx-auto" /> : det === false ? <X className="w-5 h-5 text-slate-300 mx-auto" /> : <span className="text-sm font-black text-[#4f46e5]">{det}</span>}
                  </div>
            ...
            <div className="text-center">
              <button onClick={() => setIsBookingModalOpen(true)} className="bg-[#4f46e5] text-white font-black rounded-xl px-8 py-4 hover:bg-[#4338ca] transition-colors shadow-lg shadow-indigo-400/20">
                Get GRE Voucher at ₹20,500 →
              </button>
            </div>
          </div>
        </section>
        ...
        <section className="py-24 px-6 bg-[#f8fafc]">
          <div className="max-w-5xl mx-auto space-y-12">
            <div className="text-center">
              <p className="text-xs font-bold text-[#4f46e5] uppercase tracking-widest mb-3">Student Stories</p>
                ...
                <div key={i} className="bg-white p-7 rounded-3xl border border-slate-200 shadow-sm flex flex-col">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-9 h-9 bg-[#eef2ff] rounded-full flex items-center justify-center font-black text-[#4f46e5] text-sm">{r.name.charAt(0)}</div>
                      <div>
        ...
        <section id="faq" className="py-24 px-6 bg-white">
          <div className="max-w-3xl mx-auto space-y-12">
            <div className="text-center">
              <p className="text-xs font-bold text-[#4f46e5] uppercase tracking-widest mb-3">Got Questions?</p>
              ...
              {FAQS.map((faq: any, i: number) => (
                <div key={i} className={cn("rounded-2xl border overflow-hidden transition-all", activeFaq === i ? "border-[#4f46e5]/30 bg-[#eef2ff]" : "border-slate-100 bg-[#f8fafc]")}>
                  <button onClick={() => setActiveFaq(activeFaq === i ? null : i)} className="w-full flex items-center justify-between p-6 text-left gap-4">
                    ...
                    <div className={cn("shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-all", activeFaq === i ? "bg-[#4f46e5] text-white rotate-180" : "bg-white border border-slate-200 text-slate-400")}>
        ...
        <section className="py-24 px-6 bg-[#0f172a] text-white relative overflow-hidden">
          <div className="absolute inset-0 opacity-10 bg-[radial-gradient(circle_at_30%_50%,_#4f46e5,transparent)]" />
          <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
            <div className="inline-flex items-center gap-2 bg-white/10 text-white px-4 py-2 rounded-full text-sm font-bold border border-white/10">
              <Flame className="w-4 h-4 text-[#4f46e5]" /> Limited time — Save ₹2,000 on your GRE
            </div>
            <h2 className="text-4xl md:text-5xl font-black leading-tight">
              Ready to Take the<br />
              <span className="text-[#4f46e5]">GRE General?</span>
            </h2>
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <button onClick={() => setIsBookingModalOpen(true)} className="bg-[#4f46e5] text-white font-black text-lg rounded-xl px-10 py-4 hover:bg-[#4338ca] transition-colors shadow-xl shadow-indigo-500/20 flex items-center gap-2">
                Buy Voucher — ₹20,500 <ArrowRight className="w-5 h-5" />
              </button>
